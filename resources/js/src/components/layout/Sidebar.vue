                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'dashboard'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/" @click="toggleMobileMenu">{{ $t('Task Management')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/status">{{ $t('Status Management') }}</router-link>
                                    </li>
                                    <!-- <li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'components'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/components/tabs" @click="toggleMobileMenu">{{ $t('tabs')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/accordions" @click="toggleMobileMenu">{{
                                            $t('accordions') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/modals" @click="toggleMobileMenu">{{ $t('modals')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/cards" @click="toggleMobileMenu">{{ $t('cards')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/carousel" @click="toggleMobileMenu">{{
                                            $t('carousel') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/countdown" @click="toggleMobileMenu">{{
                                            $t('countdown') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/counter" @click="toggleMobileMenu">{{ $t('counter')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/sweetalert" @click="toggleMobileMenu">{{
                                            $t('sweet_alerts') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/timeline" @click="toggleMobileMenu">{{
                                            $t('timeline') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/notifications" @click="toggleMobileMenu">{{
                                            $t('notifications') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/media-object" @click="toggleMobileMenu">{{
                                            $t('media_object') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/list-group" @click="toggleMobileMenu">{{
                                            $t('list_group') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/pricing-table" @click="toggleMobileMenu">{{
                                            $t('pricing_tables') }}</router-link>
                                    </li>
                                    <li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'elements'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/elements/alerts" @click="toggleMobileMenu">{{ $t('alerts')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/avatar" @click="toggleMobileMenu">{{ $t('avatar')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/badges" @click="toggleMobileMenu">{{ $t('badges')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/breadcrumbs" @click="toggleMobileMenu">{{
                                            $t('breadcrumbs') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/buttons" @click="toggleMobileMenu">{{ $t('buttons')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/buttons-group" @click="toggleMobileMenu">{{
                                            $t('button_groups') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/color-library" @click="toggleMobileMenu">{{
                                            $t('color_library') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/dropdown" @click="toggleMobileMenu">{{ $t('dropdown')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/infobox" @click="toggleMobileMenu">{{ $t('infobox')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/jumbotron" @click="toggleMobileMenu">{{
                                            $t('jumbotron') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/loader" @click="toggleMobileMenu">{{ $t('loader')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/pagination" @click="toggleMobileMenu">{{
                                            $t('pagination') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/popovers" @click="toggleMobileMenu">{{ $t('popovers')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/progress-bar" @click="toggleMobileMenu">{{
                                            $t('progress_bar') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/search" @click="toggleMobileMenu">{{ $t('search')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/tooltips" @click="toggleMobileMenu">{{ $t('tooltips')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/elements/treeview" @click="toggleMobileMenu">{{ $t('treeview')
                                            }}</router-link>
                                    </li>
                                    <li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'datatables'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/datatables/basic" @click="toggleMobileMenu">{{ $t('basic')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/advanced" @click="toggleMobileMenu">{{
                                            $t('advanced') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/skin" @click="toggleMobileMenu">{{ $t('skin')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/order-sorting" @click="toggleMobileMenu">{{
                                            $t('order_sorting') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/columns-filter" @click="toggleMobileMenu">{{
                                            $t('columns_filter') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/multi-column" @click="toggleMobileMenu">{{
                                            $t('multi_column') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/multiple-tables" @click="toggleMobileMenu">{{
                                            $t('multiple_tables') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/alt-pagination" @click="toggleMobileMenu">{{
                                            $t('alt_pagination') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/checkbox" @click="toggleMobileMenu">{{
                                            $t('checkbox') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/range-search" @click="toggleMobileMenu">{{
                                            $t('range_search') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/export" @click="toggleMobileMenu">{{ $t('export')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/sticky-header" @click="toggleMobileMenu">{{
                                            $t('sticky_header') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/clone-header" @click="toggleMobileMenu">{{
                                            $t('clone_header') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/datatables/column-chooser" @click="toggleMobileMenu">{{
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'forms'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/forms/basic" @click="toggleMobileMenu">{{ $t('basic')
                                            }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/layouts" @click="toggleMobileMenu">{{ $t('layouts')
                                            }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/select2" @click="toggleMobileMenu">{{ $t('select2')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/forms/touchspin" @click="toggleMobileMenu">{{ $t('touchspin')
                                            }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/switches" @click="toggleMobileMenu">{{ $t('switches')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/forms/wizards" @click="toggleMobileMenu">{{ $t('wizards')
                                            }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/clipboard" @click="toggleMobileMenu">{{ $t('clipboard')
                                            }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'users'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/users/profile" @click="toggleMobileMenu">{{ $t('profile')
                                            }}</router-link>
                                    </li>
                                    <li>
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'pages'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li @click="toggleMobileMenu">
                                        <router-link to="/pages/contact-us" target="_blank">{{ $t('contact_form')
                                            }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/pages/faq" @click="toggleMobileMenu">{{ $t('faq')
                                            }}</router-link>
                                    </li>
                                    <li @click="toggleMobileMenu">
                                        <router-link to="/pages/coming-soon" target="_blank">{{ $t('coming_soon')
                                            }}</router-link>
                                    </li>
                                    <li class="menu nav-item">
                                        <button type="button"
                                        ...
                                        <vue-collapsible :isOpen="subActive === 'error'">
                                            <ul :unmount="false" class="sub-menu text-gray-500">
                                                <li @click="toggleMobileMenu">
                                                    <router-link to="/pages/error404" target="_blank">{{ $t('404')
                                                        }}</router-link>
                                                </li>
                                                <li @click="toggleMobileMenu">
                                                    <router-link to="/pages/error500" target="_blank">{{ $t('500')
                                                        }}</router-link>
                                                </li>
                                                <li @click="toggleMobileMenu">
                                                    <router-link to="/pages/error503" target="_blank">{{ $t('503')
                                                        }}</router-link>
                                                </li>
                                            </ul>
                                        </vue-collapsible>
                                    ...
                                    <li>
                                        <router-link to="/pages/maintenence" target="_blank">{{ $t('maintenence')
                                            }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
